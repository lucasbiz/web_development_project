...
export default function Home() {
    return (
        <main className="flex justify-center items-center flex-col">
            ...
            <h1 className="text-gray-200 text-6xl mt-40">401 - Unauthorized</h1>

            <p className="text-gray-100 mt-10">Try login in or registering to the website to see this content</p>
            ...
            <div className="flex mt-20 space-x-10">
                ...
                <Link legacyBehavior href={"/register"}>
                    <button className="h-15 w-72 bg-green-500 rounded-xl hover:bg-green-600 text-xl">Register</button>
                </Link>
            </div>
        </main>
    );
